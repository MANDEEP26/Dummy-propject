...
echo "<tr><td align='left'>".$row['product_id']."&nbsp;&nbsp;</td>";
echo "<td align='left'>".$row['product_name']."&nbsp;&nbsp;</td>";
echo "<td align='left'>".$row['product_price']."&nbsp;&nbsp;</td>";
echo "<td align='left'>".$row['product_img']."&nbsp;&nbsp;</td>";
echo "<td align='left'>".$row['cat_id']."</td>&nbsp;";
echo "<td align='left'  style=' color:#FFFFFF;'><a href=userdelete.php?product_id=". $row['product_id'] ." style='color:#FF0000;'>Delete</a></td>";
echo "<tr><td colspan='9'>&nbsp;</td></tr>";
}
echo "</table>";
if($flag==0)
